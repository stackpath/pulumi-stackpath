...
namespace Stackpath.Stackpath.Compute.Inputs
{
    ...
    public sealed class WorkloadContainerEnvGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("valueFrom")]
        public Input<Inputs.WorkloadContainerEnvValueFromGetArgs>? ValueFrom { get; set; }

        public WorkloadContainerEnvGetArgs()
        {
        }
        public static new WorkloadContainerEnvGetArgs Empty => new WorkloadContainerEnvGetArgs();
    }
}
