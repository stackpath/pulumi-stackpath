...
namespace Stackpath.Stackpath
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Stackpath.Stackpath.version.txt");
    ...
    internal sealed class StackpathResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public StackpathResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
