module github.com/stackpath/pulumi-stackpath/provider
...
replace (
	...
	github.com/stackpath/terraform-provider-stackpath => ../../terraform-provider-stackpath
)

require (
	github.com/pulumi/pulumi-terraform-bridge/v3 v3.28.1
	github.com/pulumi/pulumi/sdk/v3 v3.38.0
	github.com/stackpath/terraform-provider-stackpath v1.5.0
)
